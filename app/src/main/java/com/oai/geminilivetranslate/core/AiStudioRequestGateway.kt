...
class AiStudioRequestGateway(
    ...
    data class Status(
        ...
        val templateSystemInstructionPresent: Boolean = false,
        val templateToolsPresent: Boolean = false,
        val templateCachedContentPresent: Boolean = false,
        ...
        evalJson(
            ...
            callback(
                Status(
                    ...
                    templateSystemInstructionPresent = obj.optBoolean("templateSystemInstructionPresent", false),
                    templateToolsPresent = obj.optBoolean("templateToolsPresent", false),
                    templateCachedContentPresent = obj.optBoolean("templateCachedContentPresent", false),
