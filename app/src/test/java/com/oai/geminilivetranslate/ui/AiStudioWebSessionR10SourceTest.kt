...
class AiStudioWebSessionR10SourceTest {
    ...
    @Test
    fun r12ExecutorKeepsTextPathAndUsesDirectEngineBeforeLegacyUiFallback() {
        val executor = source("src/main/java/com/oai/geminilivetranslate/core/AiStudioWebSessionExecutor.kt")
        assertTrue(executor.contains("2026-09-02-web-session-r12.0-direct-engine-executor"))
        ...
        assertTrue(executor.contains("tryLegacyProgrammaticFallback"))
