...
class AiStudioWebSessionR18SourceTest {
    ...
    fun screenDescriptionDesktopSharePathUsesDisplayMediaAndPostDrawTurnDriver() {
        ...
        assertTrue(screenBridge.contains("r19.18-hot-upgrade-desktop-share"))
        ...
        assertTrue(screenBridge.contains("__aisR19Version"))
        ...
        assertTrue(direct.contains("r14.9-hot-upgrade-turn-driver"))
        ...
        assertTrue(screenBridge.contains("ENGINE_UPGRADE"))
        assertTrue(screenBridge.contains("previousEngine.configure(false,false)"))
        assertTrue(direct.contains("ENGINE_UPGRADE"))
        assertTrue(direct.contains("__aisR14Version"))
        assertTrue(realtime.contains("BUILD_FINGERPRINT"))
