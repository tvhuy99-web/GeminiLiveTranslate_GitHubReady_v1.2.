...
app_path = Path("app/src/main/java/com/oai/geminilivetranslate/GeminiTranslateApp.kt")
app = app_path.read_text()
app = replace_once(
    app,
    "import android.app.Application\nimport android.content.Context\nimport android.os.Build\n",
    "import android.app.Activity\nimport android.app.Application\nimport android.content.Context\nimport android.os.Build\nimport android.os.Bundle\n",
    "GeminiTranslateApp imports",
)
app = replace_once(
    app,
    "import java.util.Locale\n",
    "import java.lang.ref.WeakReference\nimport java.util.Locale\n",
    "GeminiTranslateApp WeakReference import",
)
app = replace_once(
    app,
...
""",
    """        appContext = applicationContext
        ...
        val logger = SessionLogger(this, AppPreferences(this))
""",
    "GeminiTranslateApp lifecycle registration",
)
app = replace_once(
    app,
    """    companion object {
...
""",
    "GeminiTranslateApp companion",
)
app_path.write_text(app)

support_path = Path("app/src/main/java/com/oai/geminilivetranslate/network/AiStudioNativeTapDebugSupport.kt")
support_path.write_text(dedent(r'''
...
realtime_path = Path("app/src/main/java/com/oai/geminilivetranslate/network/AiStudioWebRealtimeClient.kt")
...
""",
    """            if (current != null) {
                ...
                runCatching { current.loadUrl("about:blank") }
""",
    "AiStudioWebRealtimeClient close",
)
realtime = replace_once(
    realtime,
...
""",
    """        configureWebView(created)
        ...
        WebViewCompat.addDocumentStartJavaScript(
            ...
            AiStudioWebSessionR14DirectLiveEngine.DOCUMENT_START,
""",
    "AiStudioWebRealtimeClient WebView setup",
)
realtime = replace_once(
    realtime,
...
""",
    """        private const val DIAGNOSTIC_BRIDGE_NAME = "AIStudioWebSessionLab"
        ...
        private const val AI_STUDIO_ORIGIN = "https://aistudio.google.com"
""",
    "AiStudioWebRealtimeClient bridge constant",
)
realtime = replace_once(
    realtime,
    ...
    "AiStudioWebRealtimeClient version",
)
realtime = replace_once(realtime, "CONNECT hidden=true isolatedLiveHost=true", "CONNECT hidden=false debugVisible=true isolatedLiveHost=true", "connect log")
realtime = replace_once(realtime, "RUNTIME_STARTED hidden=true isolatedLiveHost=true", "RUNTIME_STARTED hidden=false debugVisible=true isolatedLiveHost=true", "runtime log")
realtime = replace_once(realtime, "CLOSE hidden=true graceful=", "CLOSE hidden=false debugVisible=true graceful=", "close log")
realtime_path.write_text(realtime)

print("R18.4 source patch applied")
